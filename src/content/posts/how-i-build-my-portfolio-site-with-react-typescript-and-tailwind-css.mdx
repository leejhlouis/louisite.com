...
> **Historical note:** This article documents the 2024 iteration of this portfolio. Its original
> Create React App implementation and code examples differ from the current Next.js site.
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*BJPyf6aPdzZhQ-7GUGBL0w.png'
    alt='The portfolio home page in light mode'
    width={1024}
    height={566}
  />
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*xtUs2Cf2OtJdWq95awGNBw.png'
    alt='The portfolio home page in dark mode'
    width={1024}
    height={569}
  />
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/541/1*cY6466o_056cs-XXIN2U0g.png'
    alt='Browser developer tools showing the dark class on the HTML element'
    width={541}
    height={269}
  />
  <figcaption>
    The <code>dark</code> class in the HTML tag (<code>&lt;html&gt;</code>)
  </figcaption>
</figure>
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*Iknw-91uwMnBWcZluO0bQA.png'
    alt='The portfolio navbar with a frosted glass effect'
    width={1024}
    height={116}
  />
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*S5TPyH3m2V6wX7olfo0jmg.png'
    alt='Portfolio project cards with frosted glass effects'
    width={1024}
    height={517}
  />
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/proxy/1*BJPyf6aPdzZhQ-7GUGBL0w.png'
    alt='Gradient-highlighted Computer Science and Software Engineering text'
    width={2343}
    height={1295}
  />
  <figcaption>
    Rotating linear gradient highlight effect as seen in the text “Computer Science” and “Software
    Engineering”
  </figcaption>
</figure>
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*v2hUEpJTg8GwQFlpvhFwGQ.png'
    alt='The rendered Markdown on the portfolio About page'
    width={1024}
    height={570}
  />
...
<figure>
  <ArticleImage
    src='https://cdn-images-1.medium.com/max/1024/1*lSjzXdvcVjOwEL2jKHdmSQ.png'
    alt='Google Lighthouse scores for louisite.com'
    width={1024}
    height={337}
  />
  <figcaption>
    Google Lighthouse score for <a href='https://louisite.com'>louisite.com</a> (recorded on May 28,
    2024, 03:46:46 PM)
  </figcaption>
</figure>
