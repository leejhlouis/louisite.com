export const metadata = {
  ...
  description:
    'The tech stack and techniques I used to build the second iteration of my portfolio site.',
  publishedAt: '2024-05-30',
  tags: ['React', 'TypeScript', 'Tailwind CSS'],
  originalUrl:
    'https://medium.com/@leejhlouis/how-i-build-my-portfolio-site-with-react-typescript-and-tailwind-css-479778cf2960'
}
