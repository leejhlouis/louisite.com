...
Louis Gustavo is a Software Engineer at [Traveloka](https://traveloka.com) in Indonesia. He builds
web interfaces and backend systems, with experience across Spring Boot, Next.js, TypeScript,
React, Vue.js, and Laravel.
...
I'm a **Software Engineer** at [Traveloka](https://traveloka.com) and a **summa cum laude Computer Science graduate** from [BINUS University](https://binus.ac.id/) with **a GPA of 3.94**. With over three years of web development experience, my expertise spans across web development using Vue.js, React, JavaScript, SCSS, Laravel, PHP, SQL, Git, and various CI/CD tools.
